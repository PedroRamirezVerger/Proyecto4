							...
							<div class="card-body">
								...
								<p>
									...
									todas las citas que tiene programadas. Si desea modificar(<img
										src="https://image.flaticon.com/icons/png/512/23/23187.png" alt="informacion citas"
										class="img-fluid rounded" width="25" height="25">) o
									anular(<img
										src="https://image.flaticon.com/icons/png/512/39/39220.png" alt="Anulación de cita"
					...
					<!-- Tabla para la muestra de las citas que tiene un usuario -->
						<thead>
							<tr class="table-primary">
								...
								<td  scope="col"><strong>Especialidad</strong></td>
								<td  scope="col"><strong>Mï¿½dico</strong></td>
								<td  scope="col"><strong>Centro</strong></td>
							</tr>
						</thead>
					</table>
					<div align='center'>
