			...
			<div class="container center">
				...
				<div align='center'>
					<div class="col-md-6 mb-3">
						<label id="tituloCentroMedico"><strong>Centro M�dico</strong></label>
						<div>
				...
				<p align="center">
					<strong>Seleccione el especialista que quiere asignar, una vez haya
						terminado pulse el bot�n Aceptar</strong>
				</p>
				<br>
				<div class="container" id="myGroup">
						...
						<div class="container">
							<div class="collapse" id="podologo" data-parent="#myGroup">
								<table id="TablePodologo" class="table table-bordered">
										<header>Tabla lista de podologos</header>
										<!-- Tabla para la muestra de los podologos -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
											<td align="center" scope="col"><strong>Tel�fono</strong></td>
										</tr>
									</thead>
								</table>
								<div align='center'>
						...
						<div class="container">
							<div class="collapse" id="cabecera" data-parent="#myGroup">
								<table id="TableCabecera" class="table table-bordered">
										<header>Tabla lista de Medicos cabecera</header>
										<!-- Tabla para la muestra de los medicos de cabecera -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
						...
						<div class="container">
							<div class="collapse" id="traumatologo" data-parent="#myGroup">
								<table id="TableTraumatologo" class="table table-bordered">
										<header>Tabla lista de traumatologos</header>
										<!-- Tabla para la muestra de los traumatologos -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
						...
						<div class="container">
							<div class="collapse" id="alergologia" data-parent="#myGroup">
								<table id="TableAlergologia" class="table table-bordered">
										<header>Tabla lista de alergologos</header>
										<!-- Tabla para la muestra de los alergologos -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
						...
						<div class="container">
							<div class="collapse" id="geriatria" data-parent="#myGroup">
								<table id="TableGeriatria" class="table table-bordered">
										<header>Tabla lista de geriatras</header>
										<!-- Tabla para la muestra de los geriatras -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
						...
						<div class="container">
							<div class="collapse" id="enfermeria" data-parent="#myGroup">
								<table id="TableEnfermeria" class="table table-bordered">
										<header>Tabla lista de enfermeros</header>
										<!-- Tabla para la muestra de los enfermeros -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
						...
						<div class="container">
							<div class="collapse" id="pediatria" data-parent="#myGroup">
								<table id="TablePediatria" class="table table-bordered">
										<header>Tabla lista de pediatras</header>
										<!-- Tabla para la muestra de los pediatras -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
						...
						<div class="container">
							<div class="collapse" id="psiquiatria" data-parent="#myGroup">
								<table id="TablePsiquiatria" class="table table-bordered">
										<header>Tabla lista de psiquiatras</header>
										<!-- Tabla para la muestra de los psiquiatras -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
					...
					<p align='center'>
						<strong>Especialistas Elegidos</strong>
					</p>
					<div>
						<table id="TablaElegidos" class="table table">
								<header>Tabla lista de medicos elegidos</header>
								<!-- Tabla para la muestra de los medicos elegidos -->
							<thead>
								<tr class="table-primary">
								</tr>
							</thead>
