					...
					<div class="row d-flex justify-content-center">
						<div class="container">
							...
							<table id="TablaUsuarios" class="table table-bordered">
									<header>Tabla lista de usuarios</header><!-- Tabla para la muestra de los usuarios -->
								<thead>
									<tr class="table-primary">
										<td align="center" scope="col"><strong>DNI</strong></td>
										<td align="center" scope="col"><strong>Nombre</strong></td>
										<td align="center" scope="col"><strong>Centro M�dico</strong></td>
									</tr>
								</thead>
							</table>
						</div>
					...
					<div class="row d-flex justify-content-center">
						<div class="container">
							...
							<table id="TablaUsuariosCentro" class="table table-bordered">
									<header>Tabla lista de pacientes</header><!-- Tabla para la muestra de los usuarios -->
								<thead>
									<tr class="table-primary">
										<td align="center" scope="col"><strong>DNI</strong></td>
										<td align="center" scope="col"><strong>Nombre</strong></td>
						...
						<div class="row d-flex justify-content-center">
							<div class="container">
								...
								<table id="TablaMedicosCentro" class="table table-bordered">
										<header>Tabla lista de medicos</header><!-- Tabla para la muestra de los usuarios -->
									<thead>
										<tr class="table-primary">
											<td align="center" scope="col"><strong>DNI</strong></td>
											<td align="center" scope="col"><strong>Nombre</strong></td>
											<td align="center" scope="col"><strong>Centro M�dico</strong>
											<td align="center" scope="col"><strong>Especialidad</strong>
