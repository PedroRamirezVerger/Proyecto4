			...
			<div class="row d-flex justify-content-center">
				<div class="container">
					...
					<table id="Table" class="table table-bordered">
							<header>Tabla lista de citas</header><!-- Tabla para la muestra de las citas que tendrá dicho usuario -->
						<thead>
							<tr class="table-primary">
								<td align="center" scope="col"><strong>Hora</strong></td>
								<td align="center" scope="col"><strong>Fecha</strong></td>
								<td align="center" scope="col"><strong>Nombre paciente</strong></td>
								<td align="center" scope="col"><strong>DNI paciente</strong></td>
							</tr>
						</thead>
					</table>
					<div align='center'>
