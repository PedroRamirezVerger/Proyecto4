		...
		<div class="span">
			...
			<div class="row d-flex justify-content-center">
				<div class="container">
					...
					<caption>Citas guardadas</caption>
						...
						<thead>
							<tr class="table-primary">
								...
								<td align="center" scope="col"><strong>Especialidad</strong></td>
								<td align="center" scope="col"><strong>M�dico</strong></td>
								<td align="center" scope="col"><strong>Centro</strong></td>
							</tr>
						</thead>
					</table>
					<div align='center'>
