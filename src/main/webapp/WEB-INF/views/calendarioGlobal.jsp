...
<script>
	...
	function CitasOK(respuesta) {
		...
		if (jsoCitas.Citas.length == 0)
			$('#listaCitas')
					.append(
							"<a id=filas class=list-group-item list-group-item-action flex-column align-items-start active><div class=d-flex w-100 justify-content-between></div><p class=mb-1><strong>No hay citas pendientes para este día.</strong></p></a>");
		else {
